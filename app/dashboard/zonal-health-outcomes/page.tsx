...
const ZonalHealthOutcome = () => {
    ...
    const groupsOptions = [
        { value: "Zero Dose Children(12-23 months)", label: "Zero Dose Children(12-23 months)" },
        { value: "Child Health Children with Stunting", label: "Child Health Children with Stunting" },
        { value: "Child Health Children with Wasting", label: "Child Health Children with Wasting" },
...
export default ZonalHealthOutcome;
